...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Podcast | Edit</h1>
            <a href="{{ route('admin.podcast.index') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                Back</a>
        </div>

        <div class="row" style="background-color: #fff; padding: 20px; border-radius:20px;">
            <form method="post" action="{{ route('admin.podcast.update', $details->id) }}" accept-charset="UTF-8"
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    <div id="aa-1" class="tab-pane fade in active show">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label">iframe Link <span
                                                    class="text-danger">*</span></label>
                                            <input class="form-control" placeholder="" name="podcast_link" type="text"
                                                value="{{ $details->podcast_link }}">
                                        </div>
                                    </div>
                                </div>
                            </div>

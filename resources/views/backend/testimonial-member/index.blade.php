...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Member's Testimonial | Management</h1>
            <a href="{{ route('admin.member-testimonial.create') }}"
                        ...
                        @foreach ($data as $key => $testimonial)
                            <tr>
                                ...
                                <td style="font-size: 15px;"> <a
                                        href="{{ route('admin.member-testimonial.edit', $testimonial->id) }}"> <i
                                            class="fas fa-pencil-alt" title="Edit"></i> </a> &nbsp; <a
                                        href="{{ route('admin.member-testimonial.destroy', $testimonial->id) }}"

...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Member's Testimonial | Create</h1>
        ...
        <div class="row" style="background-color: #fff; padding: 20px; border-radius:20px;">
            <form method="post" action="{{ route('admin.member-testimonial.store') }}" accept-charset="UTF-8" class="form-horizontal"
                                ...
                                <div class="tab-content">
                                    <div id="aa-1" class="tab-pane fade in active show">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="" name="company"
                                                type="text">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Post</label>
                                            <input class="form-control" placeholder="" name="post"
                                                type="text">
                                        </div>
                                        <div class="form-group">

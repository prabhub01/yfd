                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div id="aa-1" class="tab-pane fade in active show">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">Excerpt <span class="text-danger">*</span>
                                        </label>
                                        <textarea class="form-control" name="excerpt" id="" cols="10"
                                            rows="6">{{ $details->excerpt }}</textarea>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="form-group"> <label class="control-label">Banner </label> <span
                                    ...
                                    @if (file_exists('uploads/blogs/banner/' . $details->banner) &&
                                    !empty($details->banner))
                                    <div class="imageContainer"> <img
                                        ...
                                        <div class="overlay"> <a
                                                ...
                                                class="icon" title="Delete this banner"> <i class="fas fa-trash-alt"
                                                    title="Delete"></i> </a>
                                        </div>
                                    </div>
                                    @endif
                            ...
                            <div class="form-group">
                                <div class="form-group"> <label class="control-label">Image </label>
                                    ...
                                    <div class="custom-file"> <input type="file" name="image"
                                            accept="image/png, image/jpeg"> </div>
                                    @if (file_exists('uploads/blogs/image/' . $details->image) &&
                                    !empty($details->image))
                                    <div class="imageContainer"> <img
                                            src=" {{ asset('uploads/blogs/image/' . $details->image) }}"
                                            alt="No Image Found" srcset="" width="100%" height="100%">
                                        <div class="overlay"> <a
                                                href="{{ route('admin.blog.destroyImage', $details->id) }}" class="icon"
                                                title="Delete this Image"> <i class="fas fa-trash-alt"
                                                    title="Delete"></i> </a>
                                        </div>
                                    </div>

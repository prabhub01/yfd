                        ...
                        @foreach ($data as $key => $event)
                            <tr>
                                ...
                                <td style="font-size: 15px;">
                                    <a href="{{ route('admin.blog.edit', $event->id) }}">
                                        <i class="fas fa-pencil-alt" title="Edit"></i> </a> &nbsp;

                                    <a href="{{ route('admin.blog.destroy', $event->id) }}"
                                        onclick="return confirm('Are you sure? This will permanently delete this Blog !')">

...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ route('admin.event.index') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                Back</a>
        </div>

        <div class="row" style="background-color: #fff; padding: 20px; border-radius:20px;">
            <form method="post" action="{{ route('admin.event.update', $details->id) }}" accept-charset="UTF-8"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="form-group"> <label class="control-label">Banner </label> <span
                                        ...
                                        @if (file_exists('uploads/events/banner/' . $details->banner) && !empty($details->banner))
                                            <div class="imageContainer"> <img src="/uploads/events/banner/{{ $details->banner }}"
                                                    alt="No Banner Image Found" srcset="" width="100%" height="100%">
                                                <div class="overlay"> <a
                                                        href="{{ route('admin.team.destroyBanner', $details->id) }}"
                                ...
                                <div class="form-group">
                                    <div class="form-group"> <label class="control-label">Image </label>
                                        ...
                                        <div class="custom-file"> <input type="file" name="image"
                                                ...
                                                <div class="imageContainer"> <img src="/uploads/events/image/{{ $details->image }}"
                                                        alt="No Banner Image Found" srcset="" width="100%" height="100%">
                                                    <div class="overlay"> <a
                                                            href="{{ route('admin.team.destroyImage', $details->id) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input class="form-control" placeholder="" name="date" type="date" value="{{ $details->date }}">
                                    </div>
                                </div>
                                <div class="form-group">

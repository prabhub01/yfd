...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ route('admin.team.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                Create New</a>
        </div>
                            ...
                            <tr>
                                ...
                                <td style="width: 30%;">
                                    @if (file_exists('uploads/team/' . $team->photo) && !empty($team->photo))
                                        <img src="{{url('/uploads/team/' . $team->photo)}}" alt="Not found" srcset="" width="30%"
                                            height="30%">
                                    @endif
                                </td>
                                ...
                                <td style="font-size: 15px;"> <a href="{{ route('admin.team.edit', $team->id) }}"> <i
                                            class="fas fa-pencil-alt" title="Edit"></i> </a> &nbsp; <a
                                        href="{{ route('admin.team.destroy', $team->id) }}">

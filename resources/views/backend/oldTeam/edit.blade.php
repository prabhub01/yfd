...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('admin.old-team.index') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
            Back</a>
    </div>

    <div class="row" style="background-color: #fff; padding: 20px; border-radius:20px;">
        <form method="post" action="{{ route('admin.old-team.update', $details->id) }}" accept-charset="UTF-8"
                ...
                <div class="col-12 col-md-4">
                    <div class="card card-custom gutter-b">
                        <div class="card-body">
                            <div class="form-group">
                                <div class="form-group">
                                    <label class="control-label">Tenure Year</label>
                                    <div class="custom-file">
                                        <input class="form-control" placeholder="Example: 2078/79" name="tenure_year"
                                            type="text" value="{{ $details->tenure_year }}">
                                    </div>
                                </div>
                                ...
                                @if (file_exists('uploads/old-team/' . $details->photo) && !empty($details->photo))
                                <div class="imageContainer"> <img src="/uploads/old-team/{{ $details->photo }}"
                                        alt="No Image Found" srcset="" width="100%" height="100%">
                                    <div class="overlay"> <a
                                            href="{{ route('admin.old-team.destroyImage', $details->id) }}" class="icon"
                                            title="User Profile"> <i class="fas fa-trash-alt" title="Delete"></i> </a>
                                    </div>
                                </div>

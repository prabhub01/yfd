...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Podcast | Create</h1>
        ...
        <div class="row" style="background-color: #fff; padding: 20px; border-radius:20px;">
            <form method="post" action="{{ route('admin.podcast.store') }}" accept-charset="UTF-8" class="form-horizontal"
                                    ...
                                    <div id="aa-1" class="tab-pane fade in active show">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label">iframe Link <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="podcast_link" class="form-control"
                                                placeholder="">
                                        </div>
                                    </div>
                                </div>

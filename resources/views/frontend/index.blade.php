...
@section('content')
    ...
    <div class="">
        <div class=" row">
            <div class="col-sm-12">
                <img src="{{ asset('img/yfd_cover.png') }}" alt="test" class="img-fluid">
                <div class="heroContent">
                    {{-- <h3>Place your main titile here</h3> --}}
                    {{-- <p class="pHero">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="ribbon" style="color: darkslategrey;">Past</div>
                                    ...
                                    @if (file_exists('uploads/blogs/image/' . $blogs->image) && !empty($blogs->image))
                                        <img src="/uploads/blogs/image/{{ $blogs->image }}" alt="Image Not found"
                                            srcset="" style="height: 200px;">
                                    @else

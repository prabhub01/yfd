...
<section>
        ...
        <div class="container">
            <div class="row">
                {{-- <p style="text-align: justify; margin: 0px 20px 0px 20px;">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui commodi placeat mollitia repellendus,
                    fugit, pariatur nisi non numquam voluptatum exercitationem labore eaque. Suscipit modi laboriosam
                    culpa consequuntur autem ipsam quidem.
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui commodi placeat mollitia repellendus,
                    fugit, pariatur nisi non numquam voluptatum exercitationem labore eaque. Suscipit modi laboriosam
                    culpa consequuntur autem ipsam quidem.
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui commodi placeat mollitia repellendus,
    ...
    <section class="se-001">
        <div class="container">
            ...
            <p style="text-align: center"> <span class="fb-like"
                    data-href="https://www.facebook.com/youthinfederaldiscourse" data-width=""
                    data-layout="button_count" data-action="like" data-size="large" data-share="true"></span></p>
        </div>
    </section>
    @endsection
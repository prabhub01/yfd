...
<section>
    ...
    <section>
        <div class="container">
            ...
            <div class="row" style="margin-bottom: 20px; background-color: #f2fdff; padding: 5px; border-radius: 10px;">
                <iframe src="{{ $podcast->podcast_link }}" height="auto" width="100%" frameborder="" scrolling="no">
                </iframe>
            </div>
            @endforeach
            @endif

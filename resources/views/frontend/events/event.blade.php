...
@section('content')
    <section class="bg-banner">
        ...
        {{-- @if (file_exists('uploads/events/banner/' . $data->image) && !empty($data->image))
            <img src="/uploads/events/banner/{{ $data->image }}" alt="Image Not found" srcset="" width="100%"
                height="250px">
        @endif --}}
    </section>
    <section>
                            ...
                            <div class="col-md-4">
                                <div class="card mb-4 box-shadow">
                                    ...
                                    @if (file_exists('uploads/events/image/' . $event->image) && !empty($event->image))
                                        <img src="/uploads/events/image/{{ $event->image }}" alt="Image Not found"

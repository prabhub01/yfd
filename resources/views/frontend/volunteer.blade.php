...
<section>
                ...
                <form action="{{ route('volunteer.store') }}" target="" method="POST">
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="secondary_contact" class="form-control" id="validationDefault03"
                                placeholder="">
                        </div>
                        <div class="col-md-5 mb-3">
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="invalidCheck2">
                                <a href="#" data-toggle="modal" data-target="#modalT&C"> Agree to terms and conditions.
                                </a>
                            </label>
                        </div>
                    </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="modalT&C" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
        aria-hidden="true">
